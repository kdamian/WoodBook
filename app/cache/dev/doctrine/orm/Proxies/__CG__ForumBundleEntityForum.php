 ...
 */
class Forum extends \ForumBundle\Entity\Forum implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'subject', 'body', '' . "\0" . 'ForumBundle\\Entity\\Forum' . "\0" . 'user'];
        }
